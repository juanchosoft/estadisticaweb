...
function renderLoginModal($logoLogin, $standalone = false){
  ...
  <style>
    ...
    .login-modal .modal-header::after{
      ...
      inset:-2px;
      background:
        radial-gradient(240px 120px at 20% 30%, rgba(255,255,255,.18), transparent 60%),
        radial-gradient(240px 120px at 90% 20%, rgba(0,194,255,.18), transparent 60%),
        radial-gradient(260px 140px at 60% 90%, rgba(124,58,237,.12), transparent 62%);
      pointer-events:none;
      opacity:.95;
    }
    ...
    .login-input{
      ...
      background: #fff;
      padding: 0 14px 0 46px; /* ✅ sin “hueco raro” */
      font-size: 16px;
      font-weight: 800;
    ...
    /* ✅ Password: deja espacio al ojo (arregla el problema visual) */
    .login-input.is-password{
            ...
            <form id="formLoginVotantes" autocomplete="on">
              ...
              <div class="login-field">
                ...
                <div class="login-input-wrap">
                  ...
                  <!-- ✅ clase is-password para padding correcto -->
                  <input type="password"
  ...
  <script>
    ...
    // Submit safe (tu JS externo decide)
    (function(){
...
if (isset($_GET['only_modal']) && $_GET['only_modal'] == '1') {
  // NO head.php aquí para no duplicar bootstrap/js en el fetch
